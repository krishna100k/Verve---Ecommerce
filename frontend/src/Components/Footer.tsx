    ...
    <Container>
      <Left>
        ...
        <Description>
          ...
          adipisci beatae id illum aliquam distinctio voluptas magni ipsum eum
          nostrum, obcaecati perspiciatis fuga dolores officiis quas veritatis,
          excepturi consectetur veniam impedit consequuntur at? Voluptatum
          omnis.
        </Description>
        <Socials>
